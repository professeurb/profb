...
C'est cet algorithme – Introsort avec finition en tri par insertion – qui est (avec des tonnes d'optimisations supplémentaires) utilisé dans la bibliothèque standard de C++. Nous allons l'étudier dans le [prochain article](quicksort3) de la série.
